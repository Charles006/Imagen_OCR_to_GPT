...
import com.xbite.charles_prado.constants.Constants.Companion.RATIO_16_9_VALUE
import com.xbite.charles_prado.constants.Constants.Companion.RATIO_4_3_VALUE
import com.xbite.charles_prado.databinding.FragmentCameraBinding
import com.xbite.charles_prado.utils.TextAnalyser
...
import com.xbite.charles_prado.customviews.ProgressDialog
import com.xbite.charles_prado.extensions.snack
...
class CameraFragment : Fragment(R.layout.fragment_camera) {
    ...
    private var
            currentLanguage = EntityExtractorOptions.SPANISH
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnchangeLanguage.setOnClickListener {
            BsLanguage.newInstance {
                currentLanguage = it
              binding.root.snack("El lenguaje fue cambiado a $it", getString(R.string.ok) )
            }.show(
        ...
        binding.textView.setText( "Cambiar Idioma: "+ currentLanguage )
    ...
    private fun getOutputDirectory(context: Context): File {
        ...
        val mediaDir = storage.internalCacheDirectory?.let {
            File(it, "Imagen_OCR_to_GPT").apply { mkdirs() }
        }
